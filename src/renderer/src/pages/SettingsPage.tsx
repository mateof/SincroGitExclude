...
export function SettingsPage() {
  ...
  const [paths, setPaths] = useState<{ dbPath: string; filesDir: string; appDataDir: string; isCustom: boolean } | null>(null)
  ...
  useEffect(() => {
    loadTags()
    window.api.invoke<IpcResult<{ dbPath: string; filesDir: string; appDataDir: string; isCustom: boolean }>>('app:get-paths').then((r) => {
